...
const ProfileIcon = () => {
  return (
    <div className="flex gap-2">
      <span className="h-10 w-10 flex items-center justify-center rounded-full cursor-pointer hover:bg-black/[0.05] hover:shadow-md">
      ...
      <span className="h-10 w-10 relative flex justify-center items-center">
        ...
        <span className="h-10 w-10 rounded-full overflow-hidden  hover:scale-105 drop-shadow-lg transition-transform">
